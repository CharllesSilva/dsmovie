create table tb_movie (id bigint AUTO_INCREMENT, count integer, image varchar(255), score double, title varchar(255), primary key (id));
create table tb_score (value double, movie_id bigint not null, user_id bigint not null, primary key (movie_id, user_id));
create table tb_user (id bigint AUTO_INCREMENT, email varchar(255), primary key (id));
